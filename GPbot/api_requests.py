...
def get_lat_lng(adress, municipality, region):
    ...
    region.replace(" ", "+")
    URL = "https://maps.googleapis.com/maps/api/geocode/json?address=" + adress + "," + municipality + "," + region + "&key=API_KEY"
...
def get_location_info(location):
    """
        ...
        - Return a string 
    """
    location_infos = requests.get("https://fr.wikipedia.org/w/api.php?format=json&action=query&prop=extracts&exintro&explaintext&redirects=1&titles=" + location + "&utf8&indexpageids").json()
